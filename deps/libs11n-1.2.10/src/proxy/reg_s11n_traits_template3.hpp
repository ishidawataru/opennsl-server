...
// s11n-proxying class templates taking three parameterized types.
...
#define S11N_TEMPLATE_TYPE_Q S11N_TEMPLATE_TYPE< T1, T2, T3 >
...
namespace s11n {
    ...
    /**
       s11n_traits<> specialization for template types taking three
       template parameters.
    */
