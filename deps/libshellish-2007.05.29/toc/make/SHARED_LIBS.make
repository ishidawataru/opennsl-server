...
# foo_so_INSTALL = 0 # optional: suppresses generation of installation rules. i.e.,
#                  foo.so will not be installed.
...
toc_link_shared_lib = { soname=$(1).so; wholename=$${soname}.$($(1)_so_MAJOR).$($(1)_so_MINOR).$($(1)_so_PATCH); \
			...
			cmd="$(CXX) $(CXXFLAGS) $(LDFLAGS) $($(1)_so_LDFLAGS) -o $${wholename} -export-dynamic -shared \
